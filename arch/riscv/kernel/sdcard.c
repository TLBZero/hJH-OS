...
/**
 * @brief Read sdcard response in R1 type. 
 */
...
/**
 * @brief Read the rest of R3 response ;
...
/**
 * @brief Read the rest of R7 response 
 * Be noticed: frame should be at least 4-byte long 
 */
...
/**
 * @brief verify supply voltage range
 * @return int 
 */
...
/**
 * @brief read OCR register to check if the voltage range is valid; this step is not mandotary, but I advise to use it
 * @return int 
 */
...
/**
 * @brief Send ACMD41 to tell sdcard to finish initializing
 * 
 * @return int 
 */
...
/**
 * @brief check OCR register to see the type of sdcard, 
